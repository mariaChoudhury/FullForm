...
<?php
  ...
  $del = "DELETE FROM form1 WHERE `id`='$id'";
  $ven = mysqli_query($conn,$del);
...
<html>
 ...
 <div class="container-fluid our_course">
			    <div class="container" id="del">
						<h1 class="text-center" style="margin-top:100px;margin-bottom: 140px;"><?php echo" Delete Successful !";?></h1>
                </div>
 </div>
    <!-- Footer-->
