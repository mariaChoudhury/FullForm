<?php
	...
	$query="UPDATE form1 SET name ='$name', father = '$father', birth = '$birth' WHERE `id`='$id'";
...
<div class="container-fluid our_course">
			       <div class="container" id="reg">
                           <h1 class="text-center"style="color: #fff; padding-bottom:10px;text-align: center;">UPDATE Result</h1> 				   
			         <div class="row">
